...
//    }
    ...
    public function GetChildMultipleAnswerList($elementCode,$docNameId){
        $sql= "SELECT DISTINCT a.element_code,a.ref_element_code,a.doc_name_id,c.element_desc,b.multi_answer_desc,b.input_type,b.sorting,b.parent_element_code "  
                ...
                ."LEFT JOIN ref_document_element c ON(c.element_code=a.element_code) "
                ."WHERE a.element_code='" . (int) $elementCode . "' AND a.doc_name_id = '$docNameId' ";
//        $sql="SELECT a.element_code,a.ref_element_code,b.multi_answer_desc,b.input_type "  
//                ."FROM ref_multiple_item a "
//                ."LEFT JOIN ref_multiple_answer b ON(a.doc_name_id=b.doc_name_id AND a.element_code=b.element_code AND a.multi_answer_desc=b.multi_answer_desc) "
//                ."WHERE a.element_code='" . (int) $elementCode . "' AND a.doc_name_id='$docNameId' ";
//        echo $sql;
