...
function InputTypeCaller($element, $name, $documentTitle,$documentId,$layout=1) {
    ...
    return $result;
        ...
        switch ($inputType):
            case '':
                $html .= '<table class="methodcolumn" style="font-size:12px;">'.'<tr>'.'<td style="padding-left:0px; padding-bottom:5px; ">'.$methodName.'</td>'.'</tr>'.'</table>';
                return $html;
            default:
                $html .= '<table class="methodcolumn" style="font-size:12px;">'.'<col width="250px"/>'.'<tr>'.'<td style="padding-left:0px;  padding-bottom:5px; vertical-align:top;">'.'<b>'.$inputType.'</b>'.'</td>'.'<td style="padding-left:5px;  padding-bottom:5px;">'.$methodName.'</td>'.'</tr>'.'</table>';
                return $html; 
        endswitch;    
}}
