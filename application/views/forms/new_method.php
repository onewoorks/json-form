                ...
                <div id='methodGrouping'>   
                    <div class="methodNew1">
                        <div class='form-group form-group-sm'>
                            <!--<div class='row'>-->
                            <label class='control-label col-sm-1'>Method Description&nbsp;<b style='color: red'>*</b></label>
                            <div class='col-sm-4'>
                            ...
                            <label class='control-label col-sm-1'>Method Info&nbsp;<b style='color: red'>*</b></label>
                            <div class='col-sm-4'>
...
<script>
    $(document).ready(function () {
        ...
        $('#methodGrouping').on('click', '.plusSection', function () {
            ...
            $method += '<label class="control-label col-sm-1">Method Description&nbsp;<b style="color: red">*</b></label>';
            ...
            $method += '</div>';
            $method += '<label class="control-label col-sm-1">Method Info&nbsp;<b style="color: red">*</b></label>';
            $method += '<div class="col-sm-4">';
