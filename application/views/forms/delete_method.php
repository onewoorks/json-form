...
<div class='form-group form-group-sm'>
    <p style='padding-left:15px'><b>Are you sure want to delete <strong class="text-capitalize"><?= $title->doc_method_desc;?></strong> ?</b></p>
...
<script>
    $('.yesDelete').click(function () {
        var values = $('#deleteDocument').serializeArray();
            $.ajax({
                url: '<?= SITE_ROOT; ?>/formview/delete-current-method/',
                data: {values:values},
