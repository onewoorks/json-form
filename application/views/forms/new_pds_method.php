                        ...
                        <div class="form-group col-md-4 text-right" >    
                           ...
                           <select name='discipline' id='discipline' class='form-control'> 
                                <option value='0' selected="selected">Please Select Discipline</option>
                                    ...
                                    <option value='<?php echo $discipline['doc_group_code']; ?>'><?php echo $discipline['doc_group_desc']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div> 
                    ...
                    <table id="listDoc" class='table table-bordered table-condensed'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  style=" font-size: smaller;"><?php echo $diagnosis['doc_group_desc']; ?></td>
                                ...
                                <td  style=" font-size: smaller;" class="text-center">
                                    <div class='btn-group btn-group-xs'>    
                                        <div data-docid="<?php echo $diagnosis['doc_name_id']; ?>" data-tempid="<?php echo $diagnosis['template_id']; ?>"  class='btn btn-default editMethod'>Edit</div>                                  
                                    </div>
                                </td>
                            </tr>
                             <?php endforeach; ?>
